...
func NewCreateSubscriptionDefault() *CreateSubscription {
	...
	var alarmNotify = &AlarmNotification{AlarmNameSpace}
	var filter = &Filter{NetconfNotificationXmlns, FilterTypeSubtree, *alarmNotify, ""}
	var sub = &CreateSubscriptionData{
		NetconfNotificationXmlns, "", "", "", *filter,
	}
